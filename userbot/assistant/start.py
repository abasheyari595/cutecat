...
async def start(event):
    catub = await tgbot.get_me()
    bot_id = catub.first_name
    catub.username
    ...
    if event.sender_id == bot.uid:
        ...
        await tgbot.send_message(
            ...
            link_preview=False,
            buttons=[
                [custom.Button.inline("تنـصيب السورس  🐍", data="deploy")],
                [Button.url("من هنا ❓", "https://dashboard.heroku.com/new?template=https://github.com/venom-ar/catpack")],
            ],
        )
